...
describe('DataGridUtil', () => {
  ...
  const allObs = {
    0: { data: dataObs(latestDate, latestStn, 'orig', latestVer, 'orig', latestTax) },
    1: { data: dataObs(latestDate, latestStn, 'CCA', latestVer, 'CCA', latestTax) },
    2: { data: dataObs(latestDate, latestStn, latestCor, latestVer, 'CCB', latestTax) },
    3: { data: dataObs(latestDate, 'abc', latestCor , '1', 'CCB_v1', latestTax) },
    4: { data: dataObs('2017-12-12T00:10:00.000Z', latestStn, latestCor, '1', 'CCB_v1', latestTax) },
    5: { data: dataObs(latestDate, latestStn, latestCor, latestVer, 'CCB', 'diffTaxonomy') },
  };
