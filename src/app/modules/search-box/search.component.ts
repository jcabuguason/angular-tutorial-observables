...
export class SearchComponent implements OnInit {
    ...
    searchForChoices(searchString: string, index: number) {
        ...
        else if (choices.includes(searchString)){
    ...
    addNewParameter(searchString: string){
        ...
        for (let word of ALL_EQUIVS){
            if (word.getEquivalents().includes(searchString)){
        ...
        for (let param of this.availableParams){
            ...
            // in the choices
            else if (param.getChoices().includes(searchString)) {
    ...
    addValueToDisplay(value: string, index: number){
        ...
        // check if has equivalent word
         for (let word of ALL_EQUIVS){
            if (word.getEquivalents().includes(value)){
                value = word.getKey();
                break;
            }
        }
        ...
        if (param.isRestricted() && !param.getChoices().includes(value)){
